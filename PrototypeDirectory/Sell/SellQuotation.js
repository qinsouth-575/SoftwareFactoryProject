// 1.销售报价单 SellQuotation

var grid_SQ = Ext.create('Ext.grid.Panel', {
	id: 'grid_SQ',
...
var formControl_SQ = Ext.create('Ext.form.Panel', {
	border: false,
	fieldDefaults: {
	...
	items: [{
		...
		},
		{
			...
			items: [{
				...
				{
					xtype: 'textfield',
					name: 'documentNumber_SQ',
					id: 'documentNumber_SQ',
					fieldLabel: "单据号码",
					labelSeparator: "<font color ='red'>*</font>:",
					allowBlank: false,
					width: '50%',
		...
		},
		{
			...
			items: [{
					xtype: 'textfield',
					name: 'purchaseRequest_SQ',
					id: 'purchaseRequest_SQ',
					fieldLabel: "业务人员",
					labelSeparator: "<font color ='red'>*</font>:",
					allowBlank: false,
					width: '50%',
				...
				{
					xtype: 'textfield',
					name: 'makingPersonnel_SQ',
					id: 'makingPersonnel_SQ',
					fieldLabel: "制单人员",
					width: '50%',
				},
			]
		},
		{
			...
			items: [{
				...
				{
					xtype: 'textfield',
					name: 'reviewingOfficer_SQ',
					id: 'reviewingOfficer_SQ',
					fieldLabel: "复核人员",
					width: '50%',
				},
			]
...
//创建活动的Window窗体
var SellQuotation = Ext.create('Ext.window.Window', {
	id: "SellQuotation",
	title: "销售报价单",
	width: 579,
	height: 366,
