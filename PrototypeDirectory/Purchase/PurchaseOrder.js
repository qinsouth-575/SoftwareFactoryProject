...
var grid_PO = Ext.create('Ext.grid.Panel', {
	id: 'grid_PO',
...
var formControl_PO = Ext.create('Ext.form.Panel', {
	border: false,
	fieldDefaults: {
	...
	items: [{
		...
		},
		{
			...
			items: [{
					xtype: 'textfield',
					name: 'supplierAddress_PO',
					id: 'supplierAddress_PO',
					fieldLabel: "供应商地址",
					width: '50%',
				},
				{
					xtype: 'textfield',
					name: 'documentNumber_PO',
					id: 'documentNumber_PO',
					fieldLabel: "单据号码",
					labelSeparator: "<font color ='red'>*</font>:",
					allowBlank: false,
					width: '50%',
		...
		},
		{
			...
			items: [{
					xtype: 'textfield',
					name: 'purchaseOrderType_PO',
					id: 'purchaseOrderType_PO',
					fieldLabel: "采购订单类型",
					width: '50%',
				},
				{
		...
		},
		{
			...
			items: [{
				...
				{
					xtype: 'combobox',
					name: 'deliveryAddress_PO',
					id: 'deliveryAddress_PO',
					fieldLabel: "送货地址",
					//store: aSingleCaseStore,
					queryMode: 'local',
					displayField: 'text',
		...
		},
		{
			...
			items: [{
				...
				items: [,
				{
					...
					items: [{
							xtype: 'textfield',
							name: 'accountOwnership_PO',
							id: 'accountOwnership_PO',
							fieldLabel: "帐款归属",
							labelSeparator: "<font color ='red'>*</font>:",
							allowBlank: false,
							width: '50%',
					...
					items: [{
						...
						{
							xtype: 'datefield',
							name: 'inTheAccountReceivable_PO',
							id: 'inTheAccountReceivable_PO',
							fieldLabel: "账款月份",
							format: 'Y-m',
							width: '50%',
						},
		...
		},
		{
			...
			items: [{
				...
				{
					xtype: 'textfield',
					name: 'makingPersonnel_PO',
					id: 'makingPersonnel_PO',
					fieldLabel: "制单人员",
					width: '50%',
				},
			]
		},
		{
			...
			items: [{
				...
				{
					xtype: 'textfield',
					name: 'reviewingOfficer_PO',
					id: 'reviewingOfficer_PO',
					fieldLabel: "复核人员",
					width: '50%',
				},
			]
		},
		{
			...
			items: [{
					xtype: 'textfield',
					name: 'subordinateToTheProject_PO',
					id: 'subordinateToTheProject_PO',
					fieldLabel: "所属项目",
					width: '50%',
				},
				{},
...
//创建活动的Window窗体
var PurchaseOrder = Ext.create('Ext.window.Window', {
	id: "PurchaseOrder",
	title: "采购订单",
	width: 579,
	height: 431,
