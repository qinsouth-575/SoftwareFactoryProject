// 1.采购请购单 PurchasePurchaseRequisition

var grid_PPR = Ext.create('Ext.grid.Panel', {
	id: 'grid_PPR',
...
var formControl_PPR = Ext.create('Ext.form.Panel', {
	border: false,
	fieldDefaults: {
	...
	items: [{
		...
		},
		{
			...
			items: [{
				...
				{
					xtype: 'textfield',
					name: 'documentNumber_PPR',
					id: 'documentNumber_PPR',
					fieldLabel: "单据号码",
					labelSeparator: "<font color ='red'>*</font>:",
					allowBlank: false,
					width: '50%',
		...
		},
		{
			...
			items: [{
					xtype: 'textfield',
					name: 'purchaseRequest_PPR',
					id: 'purchaseRequest_PPR',
					fieldLabel: "请购人员",
					labelSeparator: "<font color ='red'>*</font>:",
					allowBlank: false,
					width: '50%',
				...
				{
					xtype: 'textfield',
					name: 'makingPersonnel_PPR',
					id: 'makingPersonnel_PPR',
					fieldLabel: "制单人员",
					width: '50%',
				},
			]
		},
		{
			...
			items: [{
				...
				{
					xtype: 'textfield',
					name: 'reviewingOfficer_PPR',
					id: 'reviewingOfficer_PPR',
					fieldLabel: "复核人员",
					width: '50%',
				},
			]
...
//创建活动的Window窗体
var PurchasePurchaseRequisition = Ext.create('Ext.window.Window', {
	id: "PurchasePurchaseRequisition",
	title: "采购请购单",
	width: 579,
	height: 366,
	layout: 'fit',
