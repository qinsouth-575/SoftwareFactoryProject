...
public class PriabillDetails {
    private String priadetailsId;

    private String priabillId;

    private Float priabillPrice;

    private String priabillType;

    private String priabillNumber;
    ...
    public void setPriadetailsId(String priadetailsId) {
        this.priadetailsId = priadetailsId;
    }
    ...
    public void setPriabillNumber(String priabillNumber) {
        this.priabillNumber = priabillNumber;
    }
