...
var grid_IL = Ext.create('Ext.grid.Panel', {
	id: 'grid_IL',
	store: Ext.data.StoreManager.lookup('simpILnsStore'),
	columnLines: true,
	border: 0, //边框
	width: 559, //长度
	height: 133, //高度
	...
	columns: [{
		...
		{
			text: '(来源单别)',
			dataIndex: 'ILurceSingleType'
		},
		{
			text: '(来源单号)',
			dataIndex: 'ILurceSingleNo'
		},
		{
			text: '(分摊费用)',
			dataIndex: 'wentDutch'
...
var formControl_IL = Ext.create('Ext.form.Panel', {
	border: false,
	fieldDefaults: {
	...
	items: [{
		...
		},
		{
			...
			items: [{
					xtype: 'textfield',
					name: 'supplierAddress_IL',
					id: 'supplierAddress_IL',
					fieldLabel: "增值科目",
					width: '50%',
				},
				{
					xtype: 'textfield',
					name: 'documentNumber_IL',
					id: 'documentNumber_IL',
					fieldLabel: "单据号码",
					labelSeparator: "<font color ='red'>*</font>:",
					allowBlank: false,
					width: '50%',
		...
		},
		{
			...
			items: [{
					xtype: 'textfield',
					name: 'purchaseOrderType_IL',
					id: 'purchaseOrderType_IL',
					fieldLabel: "价值科目",
					width: '50%',
				},
				{
		...
		},
		{
			...
			items: [{
				...
				items: [,
				{
					...
					items: [{
							xtype: 'textfield',
							name: 'accountOwnership_IL',
							id: 'accountOwnership_IL',
							fieldLabel: "帐款归属",
							labelSeparator: "<font color ='red'>*</font>:",
							allowBlank: false,
							width: '50%',
					...
					items: [{
						...
						{
							xtype: 'datefield',
							name: 'inTheAccountReceivable_IL',
							id: 'inTheAccountReceivable_IL',
							fieldLabel: "账款月份",
							format: 'Y-m',
							width: '50%',
						},
		...
		},
		{
			...
			items: [{
				...
				{
					xtype: 'textfield',
					name: 'makingPerILnnel_IL',
					id: 'makingPerILnnel_IL',
					fieldLabel: "制单人员",
					width: '50%',
				},
			]
		},
		{
			...
			items: [{
				...
				{
					xtype: 'textfield',
					name: 'reviewingOfficer_IL',
					id: 'reviewingOfficer_IL',
					fieldLabel: "复核人员",
					width: '50%',
				},
			]
...
//创建活动的Window窗体
var InventoryList = Ext.create('Ext.window.Window', {
	id: "InventoryList",
	title: "盘点单",
	width: 579,
	height: 431,
