// 2.采购询价单 PurchaseInquiryList

var grid_PIL = Ext.create('Ext.grid.Panel', {
	id: 'grid_PIL',
...
var formControl_PIL = Ext.create('Ext.form.Panel', {
	border: false,
	fieldDefaults: {
	...
	items: [{
		...
		},
		{
			...
			items: [{
					xtype: 'textfield',
					name: 'supplierAddress_PIL',
					id: 'supplierAddress_PIL',
					fieldLabel: "供应商地址",
					width: '50%',
				},
				{
					xtype: 'textfield',
					name: 'documentNumber_PIL',
					id: 'documentNumber_PIL',
					fieldLabel: "单据号码",
					labelSeparator: "<font color ='red'>*</font>:",
					allowBlank: false,
					width: '50%',
		...
		},
		{
			...
			items: [{
					xtype: 'datefield',
					name: 'effectiveDate_PIL',
					id: 'effectiveDate_PIL',
					fieldLabel: "有效日期",
					labelSeparator: "<font color ='red'>*</font>:",
					allowBlank: false,
					format: 'Y-m-d',
		...
		},
		{
			...
			items: [{
					xtype: 'combobox',
					name: 'whetherTheTax_PIL',
					id: 'whetherTheTax_PIL',
					fieldLabel: "单价是否含税",
		...
		},
		{
			...
			items: [{
					xtype: 'combobox',
					name: 'deliveryAddress_PIL',
					id: 'deliveryAddress_PIL',
					fieldLabel: "送货地址",
				...
				{
					xtype: 'textfield',
					name: 'makingPersonnel_PIL',
					id: 'makingPersonnel_PIL',
					fieldLabel: "制单人员",
					width: '50%',
				},
			]
		},
		{
			...
			items: [{
				...
				{
					xtype: 'textfield',
					name: 'reviewingOfficer_PIL',
					id: 'reviewingOfficer_PIL',
					fieldLabel: "复核人员",
					width: '50%',
				},
			]
...
//创建活动的Window窗体
var PurchaseInquiryList = Ext.create('Ext.window.Window', {
	id: "PurchaseInquiryList",
	title: "采购询价单",
	width: 579,
	height: 413,
	layout: 'fit',
